...
void test_territory () {
	...
	std::cout << "Player 1 has " + std::to_string(owner.myTerritories.size()) + " territories" << std::endl;
	std::cout << "Player 2 has " + std::to_string(new_owner.myTerritories.size()) + " territories" << std::endl;

	std::cout << "Reassigning owner..." << std::endl;
	Player new_owner = Player("Player 2", 2, std::vector<int>());
