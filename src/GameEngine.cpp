...
// displays the list of files that can be played 
  ...
  // if an invalid file is selected, display an error message in red writing 
...
void MapSelectionView::display()
{
 ...
 // Increments the currently selected index
